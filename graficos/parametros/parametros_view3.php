                ...
                <div class="bs-glyphicons">
                    <ul id ="contentSlot" class="bs-glyphicons-list">
                        <li id="0" data-slot="0116" class="text-center slot" data-toggle="modal" data-target="#myModal">
                            ...
                            <div class="slot-value" id="slot-value0">00000</div>
                        ...
                        <li id="1" data-slot="0116" class="text-center slot" data-toggle="modal" data-target="#myModal">
                            ...
                            <div class="slot-value" id="slot-value1">1111111</div>
                            <div class="slot-code">feed</div>
                            <div class="">
                                <div class="pull-left">0</div>
                                <div class="pull-right">10000</div>                                    
                        ...
                        <li id="2" data-slot="0116" class="text-center slot" data-toggle="modal" data-target="#myModal">
                            ...
                            <div class="slot-value" id="slot-value2">2222222</div>
                            <div class="slot-code">feed</div>
                            <div class="">
                                <div class="pull-left">0</div>
                                <div class="pull-right">10000</div>                                    
        ...
        function loadDataSecuencial2() {
            $.ajax({
                ...
                success: function (rs){
                    //var node = $("#0").children().get(0);                        
                    if (rs[0].valor){
                        console.log("slot-value: 0108  : "+ rs[0].valor);
                        $("#slot-value1").html(""+rs[0].valor);
                    }else {
                        console.log("not data..");
                    }                    
                }
        ...
        function loadDataSecuencial3() {
            $.ajax({
                ...
                success: function (rs){
                    //var node = $("#0").children().get(0);                        
                    if (rs[0].valor){
                        console.log("slot-value2: 0113  : "+ rs[0].valor);
                        $("#slot-value2").html(""+rs[0].valor);
                    }else {
                        console.log("not data..");
                    }                    
                }
